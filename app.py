...
# --- Migration: telegram_id-based deferments -> personnel_id-based ---

# Create audit table for migration (captures old telegram_id -> new personnel_id mapping)
...
if cols and 'personnel_id' not in cols:
    cur.execute("""                        CREATE TABLE IF NOT EXISTS deferments_new (
          id           INTEGER PRIMARY KEY AUTOINCREMENT,
